...
# User Input
num_satellites = int(input("Enter the number of satellites: "))
altitude = float(input("Enter the orbital altitude (km): "))
...
# Output Results
print(f"\nDistance between satellites: {dist_between_sats:.2f} km")
